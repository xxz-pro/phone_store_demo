...
import com.southwind.phone_store_demo.repository.BuyerAddressRepository;
...
public class AddressServiceImpl implements AddressService {
    ...
    @Override
    public void deleteAddress(Integer address) {
        buyerAddressRepository.deleteByAddressId(address);
    }
